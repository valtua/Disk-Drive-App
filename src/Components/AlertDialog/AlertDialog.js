...
function AlertDialog(props) {
    ...
    return (
        <div>
            <Dialog
                open={props.alert.alertMessage}
                onClose={() => props.alert.setAlertMessage(false)}
            ...
            >
                ...
                <DialogActions>
                    <Button onClick={() => props.alert.setAlertMessage(false)}>
                        Cancelar
                    </Button>
                    <Button
                        onClick={() => {
                            props.alert.setAlertMessage(false);
                            props.selectedFile.selectedFileId
                                ? deleteFile()
                                : deleteFolder();
                        }}
                        autoFocus
